...
const freelancersArray = [
    ...
    { name: "Alex", price: 25, occupation: "painter" },
    { name: "Tim", price: 51, occupation: "photographer" },
    { name: "Sam", price: 43, occupation: "cinematographer" },
    { name: "Jay", price: 81, occupation: "graphic designer" },
    { name: "Edgar", price: 43, occupation: "maintenance" },
    { name: "David", price: 76, occupation: "programmer" },
    { name: "Joe", price: 47, occupation: "teacher" },
  ];
